// Category thumbnail images — one representative image per category.
// Search terms sourced from Fashion_Google_Image_Search_Links_195.xlsx
// Images: Unsplash (free, no auth, reliable)
