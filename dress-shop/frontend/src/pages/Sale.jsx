...
export default function Sale() {
  return (
    <div className="bg-ivory min-h-[70vh] flex flex-col items-center justify-center px-5 py-20 text-center">
      ...
      <h1 className="font-display text-3xl sm:text-4xl text-charcoal mb-3">Sale</h1>
      <p className="text-muted text-base max-w-sm leading-relaxed mb-8">
        Exciting sales are coming soon. Stay tuned for amazing deals on your favourite styles!
      </p>
      <Link
        to="/products"
